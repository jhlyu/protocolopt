...
protocol_params['b_endpoints'] = torch.tensor(protocol_params['b_endpoints'], device=torch_device, dtype=torch.float32)
...
def protocol_plot():
    ...
    b_value = phase_data_generator.piecewise_protocol_value(protocol_params['b_list'],protocol_params['b_endpoints'])
