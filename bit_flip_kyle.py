...
class PiecewiseProtocolGradient:
    ...
    def potential_value(data):
        '''
        This should return the value of the potential given some data in the form of self.phase_data coordinates
        '''
        pass

    def dphi_a(data):
        '''
        This should return the derivative of the force with respect to a
        '''
        pass

    def dphi_b(data):
        '''
        This should return the derivative of the force with respect to b
        '''
        pass

    def dv_da(data):
        '''
        This should return the derivative of potential with respect to a
        '''
        pass

    def dv_db(data):
        '''
        This should return the derivative of potential with respect to b
        '''
        pass
